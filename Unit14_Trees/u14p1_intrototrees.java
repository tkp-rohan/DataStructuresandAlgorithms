...
//      ii.)Folder Structure
//      iii.)XML/HTML Content(JSON Objects): JavaScript in browsers reads your html
//           page as a tree and manipulates this page using this tree structure.
...
public class u14p1_intrototrees{
    public static void main(String[] args) {
        ...
        // To represent an empty tree we would do the following:
        // Node root = null;

        // Representation and initialization of tree
